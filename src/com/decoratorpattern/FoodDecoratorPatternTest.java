...
public class FoodDecoratorPatternTest {
	...
	public static void main(String[] args) {
		...
		// using FoodDecarator now you can create:
		// Menemen with bologna
		// Menemen with cheese
		// Menemen with pepper
		// Menemen with bologna, cheese
		// Menemen with bologna, pepper
		// Menemen with cheese, pepper
		// Menemen with bologna, cheese, pepper
		// and
		// Karniyarik with bologna
		// Karniyarik with cheese
		// Karniyarik with pepper
		// Karniyarik with bologna, cheese
		// Karniyarik with bologna, pepper
		// Karniyarik with cheese, pepper
		// Karniyarik with bologna, cheese, pepper
	}
