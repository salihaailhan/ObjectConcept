...
public class Recursive extends GetSetMethods{
	...
	public Recursive(String wValue, int nValue) {
	...
	public void permuteString(String str, int l, int r, int[] arr) {
		if (l == r) {
			...
			int conc = calculateValues.calculate(
					calculateValues.calculate(calculateValues.calculate(arr[0], arr[1], splitString[0]), arr[2], splitString[1]), arr[3],
					splitString[2]);
			String strConc = "(((" + arr[0] + " " + splitString[0] + " " + arr[1] + ")" + " " + splitString[1] + " "
					...
					+ splitString[2] + " " + arr[3] + ")" + " > " + "("
					+ calculateValues.calculate(calculateValues.calculate(arr[0], arr[1], splitString[0]), arr[2], splitString[1]) + " "
					+ splitString[2] + " " + arr[3] + ")" + " > "
	...
	public void permuteString(String str, int l, int r, String[] arr) {
		if (l == r) {
			...
			String conc = calculateValues.calculate(
					calculateValues.calculate(calculateValues.calculate(arr[0], arr[1], splitString[0]), arr[2], splitString[1]), arr[3],
					splitString[2]);
			String strConc = "(((" + arr[0] + " " + splitString[0] + " " + arr[1] + ")" + " " + splitString[1] + " "
					+ arr[2] + ")" + " " + splitString[2] + " " + arr[3] + ")" + ")" + " > "+ "(("
