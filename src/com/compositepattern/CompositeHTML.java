...
public class CompositeHTML {
	public static void main(String[] args) throws IOException {
		...
		doc.childs.add(new HtmlUnorderedList(new Object[] {"But", "I", "am", 100.0, "sure", "that", "C++", "is", "still", "widely", "used"}));
		
		doc.childs.add(new HtmlTable(new Object[][] {{1, 5, "aha"}, {true, 0, 9}, {null, 19L, "test"}, {'C', "++", 5.0}}));
