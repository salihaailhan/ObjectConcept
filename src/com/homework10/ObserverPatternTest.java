...
public class ObserverPatternTest {
	...
	public static void main(String[] args) {
		...
		principalIntelligenceAgency1.addSubordinate(new BranchIntelligenceAgency1("Haydar", "DÜZ"));
		principalIntelligenceAgency1.addSubordinate(new BranchIntelligenceAgency1("Nurdolla", "Tilyeujan"));
