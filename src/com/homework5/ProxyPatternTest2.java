...
//import java.util.*;
//
//public class ProxyPatternTest2 {
//	public static void main(String[] args) { //
//  cube double size = 10.0; GeometryExporter.save(new Cube(size), "cube.obj");
//  
//  // sphere double radius = 10.0; int divisions = 20; GeometryExporter.save(new
//  Sphere(radius, divisions), "sphere.obj");
//  
//  // torus double innerRadius = 1.0; double outerRadius = 3.0; int
//  subdivisionCount = 30; GeometryExporter.save(new TorusProxy(innerRadius,
//  outerRadius, subdivisionCount), "torus.obj"); }}
//
//	// well-designed 3D geometry library class Vertex { double x; double y;
//	double z;
//
//	Vertex() { }
//
...
//
////
//// add here TorusProxy class 14050162001 Gürkay BAŞYİĞİT Source :
//// http://math.hws.edu/eck/cs424/notes2013/opengl-jogl/TexturedShapes.java
////
//
...
//			double s = 1.0 / subdivisionCount * i;
//
//			double centerCos = Math.cos(2 * Math.PI * s);
//			double centerSin = Math.sin(2 * Math.PI * s);
//
//			for (int j = 0; j <= subdivisionCount; j++) {
//				double t = 1.0 / subdivisionCount * j;
//				double cos = Math.cos(2 * Math.PI * t - Math.PI);
//				double sin = Math.sin(2 * Math.PI * t - Math.PI);
//				double x = centerCos * (centerRadius + tubeRadius * cos);
//				double y = centerSin * (centerRadius + tubeRadius * cos);
