...
/*
I make some changes in the homework 5 to prevent possible confusion. 
Please continue with this updated version.

Below you are given a Java source file but some parts are missing:

AdapterPatternTest.java

Complete the code so that it can produce cube.obj, sphere.obj, and torus.obj 
files. Note that, you will not change main method while adding only TorusAdapter class.

Complete code should produce below obj files (use MeshLab or Microsoft 3D 
Viewer to view these 3D models):
...
Note that, this is really a simple homework (10-15 lines of code, 
maybe up to 20 based on your coding style). 

You can view obj files using Meshlab or Microsoft 3D Viewer:
*/
